...
const dir = 'resources/metronic/src';
...
mix
  .sass('resources/css/tv.scss', `public/css/tv.css`)
  .sass('resources/css/tv-fonts.scss', `public/css/tv-fonts.css`)
  .sass('resources/mix/fonts.scss', `public/assets/plugins/global/fonts.bundle.css`)
  .sass('resources/mix/plugins.scss', `public/assets/plugins/global/plugins.bundle.css`)
  .then(() => {
...
// Build theme css/js
mix
  .sass(`${dir}/sass/style.scss`, `public/assets/css/style.bundle.css`, {sassOptions: {includePaths: ['node_modules']}})
  .sass(`${dir}/sass/style-dark.scss`, `public/assets/css/style.dark.css`, {sassOptions: {includePaths: ['node_modules']}})
  .sass(`${dir}/sass/style-light.scss`, `public/assets/css/style.light.css`, {sassOptions: {includePaths: ['node_modules']}})
  // .options({processCssUrls: false})
