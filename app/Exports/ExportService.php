...
class ExportService implements FromQuery, WithHeadings, WithStyles, ShouldAutoSize, WithEvents, Responsable, WithMapping
{
    use Exportable;
    ...
    public function __construct($query = null)
    {
        ...
        $this->fileName = "jadwal-service-" . (request()->input('month') != null ? request()->input('month') : now()->format('Y-m')) . ".xlsx";
    }
    ...
    public function headings(): array
    {
        ...
        $headers = [
            ["A" => "Jadwal Service " . (request()->input('month') != null ? request()->input('month') : now()->format('Y-m'))],
            ["A" => ""],
            ["A" => ""],
