...
class ExportUsage implements FromQuery, WithHeadings, WithStyles, ShouldAutoSize, WithEvents, Responsable, WithMapping
{
    use Exportable;
    ...
    public function __construct($query = null)
    {
        ...
        $this->fileName = "riwayat-pemakaian-" . (request()->input('month') != null ? request()->input('month') : now()->format('Y-m')) . ".xlsx";
    }
    ...
    public function headings(): array
    {
        ...
        $headers = [
            ["A" => "Riwayat Pemakaian " . (request()->input('month') != null ? request()->input('month') : now()->format('Y-m'))],
            ["A" => ""],
            ["A" => ""],
