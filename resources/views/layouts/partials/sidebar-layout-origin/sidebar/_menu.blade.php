    ...
    <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
      ...
      <div data-kt-menu-trigger="click"
        ...
        <div class="menu-sub menu-sub-accordion">
          ...
          <div class="menu-item">
            <!--begin:Menu link-->
            <a class="menu-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="{{ routed('dashboard') }}">
        ...
        <div class="menu-sub menu-sub-accordion">
          ...
          <div class="menu-item">
            ...
            <a class="menu-link {{ request()->routeIs('user-management.users.*') ? 'active' : '' }}"
               href="{{ routed('user-management.users.index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
          ...
          <div class="menu-item">
            ...
            <a class="menu-link {{ request()->routeIs('user-management.roles.*') ? 'active' : '' }}"
               href="{{ routed('user-management.roles.index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
          ...
          <div class="menu-item">
            ...
            <a class="menu-link {{ request()->routeIs('user-management.permissions.*') ? 'active' : '' }}"
               href="{{ routed('user-management.permissions.index') }}">
							<span class="menu-bullet">
								<span class="bullet bullet-dot"></span>
							</span>
