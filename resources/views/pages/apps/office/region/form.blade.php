        ...
        <div class="row mb-3">
          <div class="col-md-9 mt-2">
            ...
            <div class="mb-5">
              ...
              <select class="form-select form-select-solid form-colon" name="status">
                <option value="active" {{ old('active') == 'active' ? 'selected' : '' }} >Aktif</option>
                <option value="non_active" {{ old('non_active') == 'non_active' ? 'selected' : '' }} >Tidak Aktif</option>
              </select>
              {!! $errors->first('status', '<div class="small text-danger">:message</div>') !!}
            </div>
            <div class="mb-5">
              <label for="exampleFormControlInput1" class="form-label">Alamat</label>
              <textarea name="address" id="" cols="30" rows="10" class="form-control form-control-solid"></textarea>
              {!! $errors->first('address', '<div class="small text-danger">:message</div>') !!}
            </div>
          </div>
        </div>
