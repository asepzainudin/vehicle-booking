...
@section('content')
  <div class="card">
    ...
    <form action="{{ routed('app.vehicle-order.store') }}" method="post">
      @csrf
      <div class="card-body">
        <div class="row mb-3">
          <div class="col-md-9 mt-2">
            ...
            <div class="mb-5">
              ...
              <input type="text" class="form-control form-control-solid" name="code" placeholder="Kode" required />
            ...
            <div class="mb-5">
              ...
              <select id="vehicle_id" name="vehicle_id" class="form-control" style="width: 100%"></select>
             ...
             <div class="mb-5">
              ...
              <select id="driver_id" name="driver_id" class="form-control" style="width: 100%"></select>
            ...
            <div class="mb-5">
              ...
              <select id="reviewer_id" name="reviewer_id" class="form-control" style="width: 100%"></select>
            ...
            <div class="mb-5">
              ...
              <select id="approver_id" name="approver_id" class="form-control" style="width: 100%"></select>
