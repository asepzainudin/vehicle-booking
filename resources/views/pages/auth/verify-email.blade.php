<x-auth-layout>
  ...
  <div class="w-100">
    ...
    <div class="text-center mb-11">
      ...
      <!--end::Title-->
      <!--begin::Subtitle-->
      <div class="text-gray-500 fw-semibold fs-6">Thanks for signing up! Before getting started, could you verify your
        email address by clicking on the link we just emailed to you? If you didn\'t receive the email, we will gladly
        send you another
      </div>
      <!--end::Subtitle=-->
    ...
    <div class="d-flex flex-wrap justify-content-center pb-lg-0">
      ...
      <form method="POST" action="{{ routed('auth.verification.send') }}">
        @csrf
        <button type="submit"
                class="btn btn-lg btn-primary fw-bolder me-4">{{ __('Resend Verification Email') }}</button>
      </form>

      <form method="POST" action="{{ routed('auth.logout') }}">
        @csrf
