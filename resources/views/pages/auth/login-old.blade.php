<x-auth-layout>
  ...
  <!--begin::Form-->
  <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ routed('dashboard') }}"
        action="{{ routed('login') }}">
    @csrf
    <!--begin::Heading-->
    ...
    <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
      ...
      <!--begin::Link-->
      <a href="{{ routed('password.request') }}" class="link-primary">
        Forgot Password ?
      </a>
      <!--end::Link-->
    </div>
    ...
    <div class="text-gray-500 text-center fw-semibold fs-6">
      ...
      <a href="{{ routed('register') }}" class="link-primary">
        Sign up
      </a>
    </div>
    <!--end::Sign up-->
