      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 2.6%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-danger fs-base">{!! getIcon('arrow-down', 'fs-5 text-danger ms-n1') !!} 0.4%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 0.2%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 4.1%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 8.3%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="m-0">
            <!--begin::Label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 1.9%</span>
            <!--end::Label-->
          </div>
          <!--end::Info-->
        </div>
