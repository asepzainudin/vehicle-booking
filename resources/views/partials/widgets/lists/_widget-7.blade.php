  ...
  <div class="card-header py-7">
    ...
    <div class="m-0">
      ...
      <div class="d-flex align-items-center mb-2">
        ...
        <!--begin::Badge-->
        <span
          class="badge badge-light-danger fs-base">{!! getIcon('arrow-up', 'fs-5 text-danger ms-n1') !!} 8.02%</span>
        <!--end::Badge-->
      </div>
      <!--end::Heading-->
      <!--begin::Description-->
      ...
      <div class="d-flex flex-stack">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-center">
            <!--begin::label-->
            <span
              class="badge badge-light-success fs-base">{!! getIcon('arrow-up', 'fs-5 text-success ms-n1') !!} 2.4%</span>
            <!--end::label-->
          </div>
          <!--end::Info-->
        </div>
      ...
      <div class="d-flex flex-stack">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="d-flex flex-center">
            <!--begin::label-->
            <span
              class="badge badge-light-danger fs-base">{!! getIcon('arrow-down', 'fs-5 text-danger ms-n1') !!} 9.4%</span>
            <!--end::label-->
          </div>
          <!--end::Info-->
        </div>
