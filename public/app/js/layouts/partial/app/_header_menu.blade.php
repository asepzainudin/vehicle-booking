    ...
    <div class="hidden lg:flex lg:items-stretch" data-drawer="true"
      ...
      <div class="menu flex-col lg:flex-row gap-5 lg:gap-7.5" data-menu="true" id="megamenu">
        <div class="menu-item active">
          <a
            class="menu-link text-nowrap text-sm text-gray-700 font-medium menu-item-hover:text-primary menu-item-active:text-gray-900 menu-item-active:font-semibold"
          ...
          <div class="menu-dropdown flex-col lg:flex-row gap-0 w-full lg:max-w-[1240px]">
            <div
              ...
              <div class="menu menu-default menu-fit flex-col">
                <div class="menu-item">
                  <a
                    class="menu-link border border-transparent menu-link-hover:!bg-light menu-link-hover:border-gray-200 menu-item-active:!bg-light menu-item-active:border-gray-200 dark:menu-link-hover:!bg-coal-600 dark:menu-link-hover:border-gray-100 dark:menu-item-active:!bg-coal-600 dark:menu-item-active:border-gray-100"
                  ...
                  Datatables
                   ...
                   <span class="menu-title grow-0">
                    App Roster
                      ...
                      <div class="menu-item">
                        <a class="menu-link" href="html/demo1/network/user-base/market-authors.html"
                           tabindex="0">
                   <span class="menu-title grow-0">
                    Market Authors
                   </span>
                   ...
                   <span class="menu-title grow-0">
                    SaaS Users
                      ...
                      <div class="menu-item">
                        <a class="menu-link" href="html/demo1/network/user-base/store-clients.html"
                           tabindex="0">
                   <span class="menu-title grow-0">
                    Store Clients
                   </span>
        ...
        <div class="menu-item" data-menu-item-offset="0,0|lg:-20px, 0" data-menu-item-overflow="true"
          ...
          <div class="menu-dropdown menu-default py-2.5 w-full max-w-[220px]">
            <div class="menu-item">
              <a class="menu-link"
                 href="https://keenthemes.com/metronic/tailwind/docs/getting-started/installation" tabindex="0">
              <span class="menu-icon">
               <i class="ki-filled ki-coffee">
               </i>
              </span>
